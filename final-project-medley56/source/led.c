/**
 * @file led.c
 * @brief Implementation file for LED control functions.
 *
 * @date Created on: Sep 25, 2023
 * @author Gavin Medley
 * @see led.h
 */
#include "led.h"
...
#define TPM_CLK_SOURCE (SIM_SOPT2_TPMSRC(1))
...
void led_init()
{
	...
	GREEN_TPM->CONTROLS[GREEN_TPM_CH].CnSC = TPM_CnSC_MSB_MASK
			| TPM_CnSC_ELSA_MASK;  // edge-aligned low-true PWM
	...
	BLUE_TPM->CONTROLS[BLUE_TPM_CH].CnSC = TPM_CnSC_MSB_MASK
			| TPM_CnSC_ELSA_MASK;  // edge-aligned low-true PWM
